...
export const env = createEnv({
  server: {
    ...
    BRAND_GUIDELINES_API_KEY: z.string().min(1).optional(),
    BRAND_GUIDELINES_DEFAULT_URL: z.string().url().optional(),
  ...
  runtimeEnv: {
    ...
    BRAND_GUIDELINES_URL: process.env.BRAND_GUIDELINES_URL,
    BRAND_GUIDELINES_API_KEY: process.env.BRAND_GUIDELINES_API_KEY,
    BRAND_GUIDELINES_DEFAULT_URL: process.env.BRAND_GUIDELINES_DEFAULT_URL,
