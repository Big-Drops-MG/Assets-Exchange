      ...
      <Dialog open={isOpen} onOpenChange={handleClose}>
        ...
        >
          <DialogDescription className="sr-only">
            From and Subject lines input dialog
          </DialogDescription>
          <DialogHeader>
            <div className="flex items-center gap-3">
              ...
              />
              <DialogTitle>From & Subject Lines</DialogTitle>
            </div>
          </DialogHeader>
          <DialogBody className="max-h-[calc(90vh-180px)] overflow-y-auto">
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                >
                  Enter one from line per row. Each line will be used separately
                  in email campaigns.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                >
                  Enter one subject line per row. Each line will be used
                  separately in email campaigns.
                </p>
              </div>
              ...
              >
                <span>
                  From Lines: {fromLinesCount}{" "}
                  {fromLinesCount === 1 ? "line" : "lines"}
                </span>
                <span>
                  Subject Lines: {subjectLinesCount}{" "}
                  {subjectLinesCount === 1 ? "line" : "lines"}
                </span>
              </div>
            </div>
          </DialogBody>
